    ...
    await Booking.update(
        {
            ...
            cleanerImgLink1: process.env.LOCAL_URL+'/cleaner-images/'+imageName
        },
        {
            where:
                { id: req.body.id }
    ...
    await Booking.update(
        {
            ...
            cleanerImgLink2: process.env.LOCAL_URL+'/cleaner-images/'+imageName
        },
        {
            where:
                { id: req.body.id }
    ...
    await Booking.update(
        {
            ...
            cleanerImgLink3: process.env.LOCAL_URL+'/cleaner-images/'+imageName
        },
        {
            where:
                { id: req.body.id }
